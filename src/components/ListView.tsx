      ...
      <div className="bg-[#FDFCFB] rounded-2xl border border-[#1A1A1A]/10 p-6 space-y-5">
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          <button
            ...
            className={`px-5 py-2 rounded-full text-[10px] uppercase tracking-widest font-bold select-none cursor-pointer border transition-all duration-300 ${
              activeFilter === "all"
          ...
          <button
            ...
            className={`px-5 py-2 rounded-full text-[10px] uppercase tracking-widest font-bold select-none cursor-pointer border transition-all duration-300 flex items-center gap-1.5 ${
              activeFilter === "favorite"
                ? "bg-[#F27D26] border-[#F27D26] text-white shadow-sm"
                : "bg-transparent border-[#1A1A1A]/10 text-[#1A1A1A]/60 hover:border-[#1A1A1A]/30 hover:text-[#1A1A1A]"
            }`}
          >
            <Star className={`w-3.5 h-3.5 ${activeFilter === "favorite" ? "fill-white" : ""}`} />
            Favorites Only
          </button>
          <button
            id="filter-low-btn"
